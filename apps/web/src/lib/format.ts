 ...
 *
 * Округление безопасно ровно потому, что дробных цен в систему не пускают:
 * договорная ставка фильтруется до цифр, цена своей позиции округляется на
 * вводе. Если это когда-нибудь перестанет быть правдой, строка состава
 * «цена × количество = сумма» начнёт расходиться на рубль — чинить надо будет
 * источник дробного числа, а не это место.
 *
