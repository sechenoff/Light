...
export const ACTION_LABELS: Record<string, string> = {
  ...
  PROJECT_LOT_PLANNED: "Запланирована поставка оборудования",
  PROJECT_CONFIRMED: "Проект подтверждён",
  PROJECT_CALENDAR: "Календарь проекта изменён",
  PROJECT_ISSUED: "Оборудование проекта выдано",
  PROJECT_RETURNED: "Оборудование проекта принято",
  PROJECT_CANCELLED_LOT: "Поставка отменена",
  PROJECT_EXTENDED: "Поставка продлена",
  PROJECT_CHARGE: "Услуга добавлена",
  PROJECT_PERIOD_CLOSED: "Расчётный период закрыт",
  PROJECT_CORRECTION: "Расчёты проекта скорректированы",
  ...
  BOOKING_EDITED: "Бронь изменена",
  BOOKING_QUICK_CREATE: "Быстрая бронь создана",
  BOOKING_AUTO_CONFIRMED: "Бронь подтверждена без согласования",
  BOOKING_CONFIRMED: "Бронь подтверждена",
  BOOKING_ADDON_ADDED: "Добавлено оборудование",
  BOOKING_ADDON_MERGED: "Добор включён в основную смету",
  BOOKING_DEBT_FORGIVEN: "Долг прощён",
  BOOKING_DEBT_WRITE_OFF: "Долг списан",
  BOOKING_DEBT_WRITE_OFF_CANCELLED: "Списание долга отменено",
  PAYMENT_STATUS_CHANGED: "Статус оплаты изменён",
  DEBT_FORGIVEN: "Долг прощён",
  BILL_CREATE: "Счёт на оплату создан",
  BILL_UPDATE: "Счёт на оплату изменён",
  BILL_STATUS: "Статус счёта на оплату изменён",
  REPAIR_ETA_SET: "Изменён срок ремонта",
