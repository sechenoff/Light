...
export function MiniCalendar() {
  ...
  return (
    <div className="relative">
      {loading && (
        <div className="absolute inset-0 flex items-center justify-center bg-surface/60 z-10 rounded">
          <div className="w-5 h-5 border-2 border-border-strong border-t-ink-2 rounded-full animate-spin" />
        </div>
      )}
      <DayPicker
        locale={ru}
        ...
        classNames={{
          root: "text-sm",
          month_caption: "text-xs font-semibold text-ink-2 mb-1",
