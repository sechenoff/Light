/**
 * Типы ответов API инвентаризации — зеркало apps/api/src/services/stockCount/types.ts.
 * Веб не импортирует пакет API, поэтому копия; при изменении контракта править оба файла.
 */
