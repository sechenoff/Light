      ...
      <div className="border border-border rounded-lg bg-surface focus-within:border-accent transition-colors">
        ...
        <div className="flex items-center justify-between px-3 py-1.5 border-t border-border">
          ...
          <button
            onClick={submit}
            disabled={!draft.trim()}
            className="min-h-9 text-[13px] font-medium px-3 py-1.5 sm:min-h-0 sm:py-1 rounded-md bg-accent-bright text-surface disabled:opacity-40 hover:opacity-90 transition-opacity"
          >
            Отправить
          </button>
        </div>
