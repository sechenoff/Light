...
export function ProblemItemsPage() {
  ...
  return (
    <>
      {/* Каркас как у вкладок инвентаризации (общий PageHead, ширина 1240) — при
          переходе по подменю склада шапка и контейнер не прыгают. Запас под кнопку
          «Сообщить» даёт <main> в AppShell. */}
      <div className="mx-auto w-full max-w-[1240px] p-4 lg:p-6 space-y-4">
