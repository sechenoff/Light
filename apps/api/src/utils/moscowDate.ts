/**
 * Утилиты для работы с датами в московском времени (Europe/Moscow, UTC+3, без перехода на летнее время).
 *
 ...
 * Например, если сейчас 2026-04-20 02:00 UTC, то московское время 2026-04-20 05:00,
 * и функция вернёт 2026-04-19T21:00:00Z (полночь Москвы).
 */
